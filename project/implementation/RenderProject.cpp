...
//        shader[i]->setUniform("modelMatrixTerrain", modelMatrixTerrain);
...
//        
//        shader[i]->setUniform("LightPos", vmml::Vector4f(.5f, 100.f, 30.5f, 1.f));
...
//        shader[i]->setUniform("Is", vmml::Vector3f(1.f));
    ...
    //shader[1]->setUniform("NormalMatrix", vmml::Matrix3f(modelMatrixTerrain));
    bRenderer().getModelRenderer()->drawModel("terrain", "camera", modelMatrixTerrain, std::vector<std::string>({ }));
    //shader[0]->setUniform("NormalMatrix", vmml::Matrix3f(modelMatrix));
    bRenderer().getModelRenderer()->drawModel("plane", "camera", modelMatrix, std::vector<std::string>({ }));
